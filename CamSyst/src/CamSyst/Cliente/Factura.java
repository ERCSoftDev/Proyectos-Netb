...
import static CamSyst.Administrador.comprobante.numComprob02;
...
public final class Factura extends javax.swing.JInternalFrame {
   ...
   public Factura(String user, String password) throws SQLException {
       initComponents();
...
if(opcion==JOptionPane.YES_NO_OPTION)
{
     try {
          ...
          formaPago bs = new formaPago(userName,passWord);
...
private static double redondearPuntos  (double suma,int numDecimal)  {
    ...
    private void initComponents() {
        ...
        jtf_total.setForeground(new java.awt.Color(0, 102, 204));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(jLabel14)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jtf_total, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(22, 22, 22))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGap(6, 6, 6)
                        .addComponent(jPanel3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void buscarClientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarClientesActionPerformed
       validar();
        BuscarCliente bc=new BuscarCliente(this.userName,this.passWord);
