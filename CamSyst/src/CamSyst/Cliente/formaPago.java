...
public class formaPago extends javax.swing.JInternalFrame {
   ...
   String passWord;
    ...
    public formaPago(String user, String password) {
        initComponents();
     ...
     //   Factura.numComprobF02();
      //  Factura.incrementarncf();
        try {
           ...
           Pago bs = new Pago(this.userName,this.passWord);
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        try {
            ConsultaClientesrnc bs = new ConsultaClientesrnc(this.userName,this.passWord);
           jDesktopPane1.add(bs);
           bs.toFront();
           bs.setVisible(true);       
