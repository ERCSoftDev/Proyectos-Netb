...
Connection cn;
   ...
   String passWord;
    ...
    public VentanaConsult(String user,String password) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try{
        ConsultaClientes v =new  ConsultaClientes(this.userName,this.passWord);
        jDesktopPane1.add(v);
        v.show();
       }catch (Exception e){}
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       try{
        ConsultaProductos v =new  ConsultaProductos(this.userName,this.passWord);
        jDesktopPane1.add(v);
        v.show();
       }catch (Exception e){}
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       try{
        ConsultaFactura v =new  ConsultaFactura(this.userName,this.passWord);
        jDesktopPane1.add(v);
        v.show();
       }catch (Exception e){} 
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       try{
        ConsultaProveedores v =new  ConsultaProveedores(this.userName,this.passWord);
        jDesktopPane1.add(v);
        v.show();
       }catch (Exception e){}
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try{
        ConsultaFacturaCli v =new  ConsultaFacturaCli(this.userName,this.passWord);
        jDesktopPane1.add(v);
        v.show();
       }catch (Exception e){} 
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
       try{
        ConsultasEmpleados v =new  ConsultasEmpleados(this.userName,this.passWord);
        jDesktopPane1.add(v);
        v.show();
       }catch (Exception e){}
