...
public class CamS extends javax.swing.JFrame{
    ...
    public CamS(String user, String password) {
...
try{
        Empleados f=new Empleados(this.userName,this.passWord);
        jDesktopPane1.add(f);
        f.setLocation(50, 5); 
        f.show();
        f.setVisible(true);
...
try{
 ...
 JOptionPane.showMessageDialog(this,"Estimado "+userName+" Esta ventana esta en mantenimiento"+"\nContacte con el Administrador"
        ...
        try{
            ...
            ReporteProductos ac =new ReporteProductos(this.userName,this.passWord);
            jDesktopPane1.add(ac);
            ac.show();
            ac.setVisible(false);
            ac.setLocation(50, 5);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            JOptionPane.setRootFrame(this);
            Empleados ac =new Empleados(this.userName,this.passWord);
            jDesktopPane1.add(ac);
            ac.show();
            ac.setVisible(false);
            ac.setLocation(50, 5);
    ...
    try{
        Proveedor p =new  Proveedor(this.userName,this.passWord);
        jDesktopPane1.add(p);
        p.show();
       }catch (Exception e){}
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try{
        VentanaConsult p =new   VentanaConsult(this.userName,this.passWord);
        jDesktopPane1.add(p);
        p.show();
       }catch (Exception e){}
...
if(userName.equals("empleado")){
        try{
            ...
            JOptionPane.setRootFrame(this);
            VentanaReportes ac =new VentanaReportes(this.userName,this.passWord);
            jDesktopPane1.add(ac);
            ac.show();
            ac.setVisible(false);
            ac.setLocation(50, 5);
    ...
    private void jMenuItem13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem13ActionPerformed
        try{
        Proveedor f=new Proveedor(this.userName,this.passWord);
        jDesktopPane1.add(f);
        f.setLocation(50, 5); 
        f.show();
        f.setVisible(true);
    ...
    private void jMenuItem8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem8ActionPerformed
     try{
        ConsultaProveedores f=new ConsultaProveedores(this.userName,this.passWord);
        jDesktopPane1.add(f);
        f.setLocation(50, 5); 
        f.show();
        f.setVisible(true);
    ...
    private void jMenuItem10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem10ActionPerformed
       try{
        ...
        ConsultasEmpleados f=new ConsultasEmpleados(this.userName,this.passWord);
        jDesktopPane1.add(f);
        f.setLocation(50, 5); 
        f.show();
        f.setVisible(true);
    ...
    private void jMenuItem14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem14ActionPerformed
        ...
        try{
            ...
            JOptionPane.setRootFrame(this);
            RegistroMovUsuarios ac =new RegistroMovUsuarios(this.userName,this.passWord);
            jDesktopPane1.add(ac);
            ac.show();
            ac.setVisible(false);
            ac.setLocation(50, 5);
    ...
    private void jMenuItem15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem15ActionPerformed
        ...
        try{
            ...
            JOptionPane.setRootFrame(this);
            RegistrosDeIngresosFact ac =new RegistrosDeIngresosFact(this.userName,this.passWord);
            jDesktopPane1.add(ac);
            ac.show();
            ac.setVisible(false);
            ac.setLocation(50, 5);
    ...
    private void jMenuItem23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem23ActionPerformed
         try{
        Empresa f=new Empresa(this.userName,this.passWord);
        jDesktopPane1.add(f);
        f.setLocation(50, 5); 
        f.show();
        f.setVisible(true);
    ...
    private void jMenuItem24ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem24ActionPerformed
       try{
        PoncheEmpleados f=new PoncheEmpleados(this.userName,this.passWord);
        jDesktopPane1.add(f);
        f.setLocation(50, 5); 
        f.show();
        f.setVisible(true);
...
try{
    ...
    private void jMenuItem34ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem34ActionPerformed
       try{
        Usuarios  p= new Usuarios (this.userName,this.passWord);
        jDesktopPane1.add(p);
        p.setLocation(50, 5); 
        p.show();
        p.setVisible(true);
