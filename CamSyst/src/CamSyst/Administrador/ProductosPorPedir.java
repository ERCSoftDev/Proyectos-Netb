...
public class ProductosPorPedir extends javax.swing.JInternalFrame {
ClassConection conectar=new ClassConection();
    
    Connection con;
    CallableStatement cst;
    ResultSet r;
    public ProductosPorPedir(String user, String password) {
        initComponents();
    ...
    cargar();
     ...
     private void cargar(){
       ...
       tabla.addColumn("CANT. A PEDIR");
       
         cst=con.prepareCall("{call mostrarproApedir}");
       r=cst.executeQuery();
       while (r.next()){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try{
    String rutaInforme= "C:\\Program Files\\Camsyst\\Reportes\\ProductosPorPedir.jrxml";
        Reportes re= new Reportes();
        re.verReporte10(rutaInforme);
