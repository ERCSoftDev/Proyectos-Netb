...
ClassConection  conectar = new ClassConection();
   ...
   public Proveedor(String user, String password) {
...
private void cargar(){
    ...
    private void initComponents() {
        ...
        jTable1.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(102, 102, 255), null));
        ...
        jTextField4.setForeground(new java.awt.Color(248, 100, 100));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String cod=JOptionPane.showInputDialog("INGRESE EL NOMBRE DEL PROVEEDOR A BUSCAR si decea puede modificar o eliminar el registro");
          try {
            ...
            this.jTextField8.setText(r.getString(6));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        String idcliente=jTextField1.getText(),nombrecli=jTextField2.getText(),apecli=jTextField3.getText();
        
        String rnc=   jTextField6.getText();
        String telcli=jTextField5.getText(),dircli=jTextField7.getText();
        String cedcli=jTextField7.getText();
        
        try {
           // cst=con.prepareCall("{call modificarProvee(?,?,?,?,?,?,?)}");
            cst.setString(1, idcliente);
            cst.setString(2, nombrecli);
            cst.setString(3, apecli);
            
            cst.setString(4, rnc);
            cst.setString(5, telcli);
            cst.setString(6,cedcli);
            cst.setString(7,dircli);
            int rpta=cst.executeUpdate();
            if(rpta==1){
