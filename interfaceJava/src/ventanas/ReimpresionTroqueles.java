 ...
 * @author jpaula
 */
public class ReimpresionTroqueles extends javax.swing.JFrame {

    /**
     * Creates new form ReimpresionTroqueles
     */
    public ReimpresionTroqueles() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Reimpresión Solicitud Troqueles");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReimpresionTroqueles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReimpresionTroqueles().setVisible(true);
            }
        });
    }
