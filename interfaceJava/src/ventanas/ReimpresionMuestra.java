 ...
 * @author jpaula
 */
public class ReimpresionMuestra extends javax.swing.JFrame {

    /**
     * Creates new form ReimpresionMuestra
     */
    public ReimpresionMuestra() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Reimpresión Solicitud Muestras");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReimpresionMuestra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReimpresionMuestra().setVisible(true);
            }
        });
    }
