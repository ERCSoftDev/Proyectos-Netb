...
public class Empleados extends javax.swing.JInternalFrame {
  ...
  // ClassConection conectar=new ClassConection();
    ...
    private void registrarUsuario(){
        ...
        String nick=            jTextField10.getText();
        String pass      =      jPasswordField1.getText();
        String confirpass    =  jPasswordField2.getText();
        String tipo =           jComboBox2.getSelectedItem().toString();
        
         try {
            cts=cn.prepareCall("{call registrarusuario(?,?,?,?,?)}");
            cts.setString(1, cod);
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tipo usuario", "Administrador", "Encargado", "Asistente", "Cajer@s", "Atencion", "Programador" }));
