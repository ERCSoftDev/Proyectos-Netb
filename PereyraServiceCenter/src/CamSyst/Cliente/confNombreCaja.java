...
public class confNombreCaja extends javax.swing.JInternalFrame {
 ...
 ClassConection conectar=new ClassConection();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String nombre=confNombreCaja.jTextField1.getText();
        FacturaCajeros.jLabel16.setText(nombre);
        registarNombre();
        llamada();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(confNombreCaja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new confNombreCaja().setVisible(true);
            }
        });
    }
