...
public class BuscarClienteCajeros extends javax.swing.JInternalFrame {
   ...
   ListSelectionModel lsClientes;
    ...
    public void SelecionaCLiente(){
       ...
       // DefaultTableModel modelo = (DefaultTableModel) Cotizacion.jtableDetalle.getModel();
        int row=BuscarClienteCajeros.jTable1.getSelectedRow();
        
        String id=BuscarClienteCajeros.jTable1.getValueAt(row, 0).toString();
        String nom=BuscarClienteCajeros.jTable1.getValueAt(row, 1).toString();
        String ape=BuscarClienteCajeros.jTable1.getValueAt(row, 2).toString();
        String ced=BuscarClienteCajeros.jTable1.getValueAt(row, 3).toString();
        String cel=BuscarClienteCajeros.jTable1.getValueAt(row, 5).toString();
        String dir=BuscarClienteCajeros.jTable1.getValueAt(row, 6).toString();
        String blue=BuscarClienteCajeros.jTable1.getValueAt(row, 7).toString();
...
private void cargar(){
    ...
    private void initComponents() {
        ...
        jTextField1.setCaretColor(new java.awt.Color(102, 204, 0));
        jTextField1.setSelectionColor(new java.awt.Color(102, 204, 0));
        ...
        jTable1.setSelectionForeground(new java.awt.Color(102, 204, 0));
...
buscarcliente(); 
    ...
    private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
       if(evt.getKeyCode() == KeyEvent.VK_ENTER) {
           //buscarart(); 
           BuscarClienteCajeros.jTable1.requestFocusInWindow();
        }
