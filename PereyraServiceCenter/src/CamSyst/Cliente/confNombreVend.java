...
public class confNombreVend extends javax.swing.JInternalFrame {
 ...
 ClassConection conectar=new ClassConection();
    ...
    private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
        ...
        FacturaVendedor.jTextField8.setText("FACTURA DE CONSUMO");
        registarNombre();
        llamada();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(confNombreVend.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new confNombreVend().setVisible(true);
            }
        });
    }
