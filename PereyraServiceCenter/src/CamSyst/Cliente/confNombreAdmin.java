...
public class confNombreAdmin extends javax.swing.JInternalFrame {
 ...
 ClassConection conectar=new ClassConection();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(confNombreAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new confNombreAdmin().setVisible(true);
            }
        });
    }
