...
public final class FacturaVendedor extends javax.swing.JInternalFrame {
...
public FacturaVendedor() throws SQLException {
       initComponents();
       jTextField2.requestFocusInWindow();
       FacturaVendedor.jTextField3.setEnabled(false);
...
public static void puntos()          {
        ...
        double tot=Double.parseDouble(FacturaVendedor.jtf_total.getText());
...
public static void limpiar()         {
           FacturaVendedor.JLB_codCliente.setText("");
           FacturaVendedor.jLabel16.setText  ("");
           FacturaVendedor.jLabel18.setText("");        
           FacturaVendedor.telefo.setText("");
           FacturaVendedor.jLabel20.setText("");
           FacturaVendedor.jTextField4.setText("");
           FacturaVendedor.jTextField3.setText("");
           FacturaVendedor.jTextField5.setText("");
           FacturaVendedor.jTextField6.setText("");
           FacturaVendedor.jTextField7.setText("");
           FacturaVendedor.jTextField8.setText("");
           FacturaVendedor.jTextField2.setText("");
           FacturaVendedor.jtf_subto.setText(""); 
           FacturaVendedor.jtf_desc.setText("");
           FacturaVendedor.jtf_igv.setText("");
           FacturaVendedor.jtf_total.setText("");
...
if(jTextField2.getText().length()>0){;
   ...
   while (r.next()){
     ...
     //  Selecionaarticulo();
          ...
          Logger.getLogger(FacturaVendedor.class.getName()).log(Level.SEVERE, null, ex);
      }
}
}
...
JOptionPane.showMessageDialog(null, "DEBE INGRESAR LA FECHA CORRECTAMENTE PARA PAGAR ESTA FACTURA t/"+""+"DD-MM-YYYY");
 jTextField3.requestFocusInWindow();
     ...
     try {  
           PagoAdmin bs = new PagoAdmin();
           vendedor.jDesktopPane1.add(bs);
           bs.toFront();
           bs.setVisible(true);       
           FacturaVendedor.operaci4();
...
public static void revision()            {
    ...
    DefaultTableModel modelo = (DefaultTableModel) FacturaVendedor.jtableDetalle.getModel();   
    int row=jtableDetalle.getSelectedRow();
...
try{
        confNombreVend f=new confNombreVend();
        vendedor.jDesktopPane1.add(f);
...
try{
        confNombreVendComprob f=new confNombreVendComprob();
        vendedor.jDesktopPane1.add(f);
        f.setLocation(50, 5); 
        f.show();
        f.setVisible(true);
...
private static double redondearPuntos  (double suma,int numDecimal)  {
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Totales", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jtableDetalle.setGridColor(new java.awt.Color(255, 51, 51));
        jtableDetalle.setSelectionBackground(new java.awt.Color(255, 0, 0));
        ...
        formaPago.setBackground(new java.awt.Color(255, 0, 0));
    ...
    private void buscarArticuloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarArticuloActionPerformed
       ...
       try {
           validar();
           BuscarArticulosVend bs = new BuscarArticulosVend();
          vendedor.jDesktopPane1.add(bs);
           bs.toFront();
    ...
    try {
           ...
           formaPagoSuspVend bs = new formaPagoSuspVend();
           vendedor.jDesktopPane1.add(bs);
           bs.toFront();
           bs.setVisible(true);       
       } catch (Exception e){}             
...
if(evt.getKeyChar()== KeyEvent.VK_F2 && FacturaVendedor.jtf_total.getText().length()>0){     
    validar();
    guardar();
    }else
         JOptionPane.showMessageDialog(null,"DEBE AGREGAR UN ARTICULO A LA FACTURA");
