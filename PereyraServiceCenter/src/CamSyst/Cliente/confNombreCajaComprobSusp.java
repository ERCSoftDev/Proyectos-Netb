...
public class confNombreCajaComprobSusp extends javax.swing.JInternalFrame {
 ...
 ClassConection conectar=new ClassConection();
    ...
    public confNombreCajaComprobSusp() {
        initComponents();
    ...
    private void llamada(){
        ...
        FacturaCajeros.agregarDetSusp();
        FacturaCajeros.agregarFacCliSusp();
    ...
    private void registarNombre(){
     String codcli=   FacturaCajeros.JLB_codCliente.getText();
     String n_fact=   FacturaCajeros.jTextField10.getText();
     String nombre=   jTextField1.getText();   
     String total=    FacturaCajeros.jtf_total.getText();
    ...
    private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
         if(evt.getKeyCode() == KeyEvent.VK_ENTER) {
            FacturaCajeros.numid();
            FacturaCajeros.jTextField8.setText("COMPROBANTE FISCAL");
            registarNombre();
            llamada();
            FacturaCajeros.datocli();
         }       
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(confNombreCajaComprobSusp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new confNombreCajaComprobSusp().setVisible(true);
            }
        });
    }
