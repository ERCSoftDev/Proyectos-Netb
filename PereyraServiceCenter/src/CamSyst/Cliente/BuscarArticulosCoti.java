...
public class BuscarArticulosCoti extends javax.swing.JInternalFrame {
...
public BuscarArticulosCoti() throws SQLException {
    initComponents();
 ...
 private void cargar(){
     ...
     cts=cn.prepareCall("{call mostrarpro3}");
       ...
       BuscarArticulosCoti.jTable1.setModel(tabla);
 ...
 Selecionaarticulo();
    ...
    public void Selecionaarticulo(){
        ...
        DefaultTableModel modelo = (DefaultTableModel) Cotizacion1.jtableDetalle.getModel();
        int row=jTable1.getSelectedRow();
        ...
        String Itbis=jTable1.getValueAt(row, 5).toString();
         ...
         Object[]  dato=new Object[6];
            ...
            Cotizacion1.operaci();
           // Cotizacion.calcularpuntos();
            modelo.addRow(dato);
            Cotizacion1.jtableDetalle.setModel(modelo);
            Cotizacion1.ajustarcolumnas();
            dispose();
           Cotizacion1.jTextField2.requestFocusInWindow();
