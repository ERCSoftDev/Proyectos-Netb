...
import static CamSyst.Cliente.Factura.numid;
...
public class confNombreAdminSusp extends javax.swing.JInternalFrame {
 ...
 ClassConection conectar=new ClassConection();
    ...
    private void registarNombre(){
     ...
     String id=   Factura.jTextField10.getText();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      //  Factura.numfac();
       // Factura.numComprobF02();
        String nombre=jTextField1.getText();
        Factura.jLabel16.setText(nombre);  
        Factura.jTextField8.setText("FACTURA DE CONSUMO"); 
        registarNombre();
        llamada();
        Factura.datocli();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(confNombreAdminSusp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new confNombreAdminSusp().setVisible(true);
            }
        });
    }
