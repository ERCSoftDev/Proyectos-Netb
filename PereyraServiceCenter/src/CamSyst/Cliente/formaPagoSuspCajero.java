...
import CamSyst.Consultas.ConsultaClientesrncCajeroSusp;
import CamSyst.Consultas.ConsultaClientesrncVend;
import CamSyst.Consultas.ConsultaClientesrncVendSusp;
...
public class formaPagoSuspCajero extends javax.swing.JInternalFrame {
  ...
  FacturaCajeros.enviarFactura();
  FacturaCajeros.validNombreClientes();
  ...
  dispose();
   ...
   try {
           ConsultaClientesrncCajeroSusp bs = new ConsultaClientesrncCajeroSusp();
           Cajeros.jDesktopPane1.add(bs);
           bs.toFront();
           bs.setVisible(true);       
           ConsultaClientesrncCajeroSusp.jTextField2.requestFocusInWindow();
       } catch (Exception e){}
        this.dispose();


//  comprobante.numComprob01();
