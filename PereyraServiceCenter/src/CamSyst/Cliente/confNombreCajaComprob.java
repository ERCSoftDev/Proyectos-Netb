...
public class confNombreCajaComprob extends javax.swing.JInternalFrame {
 ...
 ClassConection conectar=new ClassConection();
    ...
    private void registarNombre(){
     ...
     String n_fact=   FacturaCajeros.jTextField4.getText();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(confNombreCajaComprob.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new confNombreCajaComprob().setVisible(true);
            }
        });
    }
