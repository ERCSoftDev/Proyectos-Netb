...
public static void operaci()         {
         ...
         double ic;
             ...
             jtableDetalle.setValueAt(""+redondearTotal(itb2,2), i, 5);
...
public static void operacides()         {
         ...
         double itbis;
             ...
             double d=Double.parseDouble(precioV);
             double it=Double.parseDouble(Itbis);
             String val3 = jtf_desc.getText(); 
             double decc=Double.parseDouble(val3);
            ...
            itb2=d*0.18;
             ...
             jtableDetalle.setValueAt(""+redondearTotal(suma,2), i, 7);
             jtf_subto.setText(""+redondearSubtotal(subtot,2));
             jtf_desc.setText(""+redondearDes(decc,2));
             jtf_igv.setText(""+redondearItbis(itb,2));
             jtf_total.setText(""+redondearTotal(des,2));
...
public static void imprimir()        {
    try{
    String rutaInforme= "C:\\Program Files\\Camsyst\\Reportes\\FacturaGourmeticket.jrxml";
...
try{
        confNombreAdminComprobSusp f=new confNombreAdminComprobSusp();
        CamS.jDesktopPane1.add(f);
        f.setLocation(50, 5); 
        f.show();
        f.setVisible(true);
...
private static double redondearPuntos  (double suma,int numDecimal)  {
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jtf_igv, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(83, 83, 83))
        );
        ...
        eliminarFila.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        NoFactSusp.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jPanel1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(153, 204, 255), 3, true));
        ...
        buscarClientes.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        buscarArticulo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Screenshot (17).png"))); // NOI18N
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addContainerGap())
                            .addComponent(buscarArticulo, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)))))
        );
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(jLabel13)
                        .addGap(28, 28, 28)
                        .addComponent(buscarArticulo, javax.swing.GroupLayout.PREFERRED_SIZE, 194, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(33, 33, 33)
    ...
    try {
           ...
           formaPagoSuspAdmin bs = new formaPagoSuspAdmin();
           CamS.jDesktopPane1.add(bs);
           bs.toFront();
           bs.setVisible(true);       
       } catch (Exception e){}             
...
if(evt.getKeyChar()== KeyEvent.VK_F2 && Factura.jtf_total.getText().length()>0){     
    validar();
    guardar();
    }else
         JOptionPane.showMessageDialog(null,"DEBE AGREGAR UN ARTICULO A LA FACTURA");
...
JOptionPane.showMessageDialog(null, "DEBE AGREGAR UN ARTICULO A ESTA FACTURA");
 jTextField2.requestFocusInWindow();
    ...
    try {
           ...
           Factura.numfac();              
        Factura.numComprobF02();
        Factura.incrementarncf();
    Factura.guardar();
    dispose();         
       }
    ...
    else if (Factura.jTextField8.getText().equals("COMPROBANTE FISCAL")&& formaPago.getSelectedItem().equals("Contado")){
    ...
    try {
        ...
        this.dispose(); 
         ...
         if (jTextField3.getText().length()>=2 && formaPago.getSelectedItem().equals("Credito")&& !jLabel16.getText().equals("Sin nombre"))
         {
           ...
           formaPagoAdmin bs = new formaPagoAdmin();
           CamS.jDesktopPane1.add(bs);
           bs.toFront();
           bs.setVisible(true);        
...
//enviarFactura();
   ...
   // }else
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
      jtf_desc.setEnabled(true);
        
        jtf_desc.setText("");
        jtf_desc.requestFocusInWindow();
    }//GEN-LAST:event_jCheckBox1ActionPerformed

    private void jtf_descKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtf_descKeyPressed
      if(evt.getKeyCode() == KeyEvent.VK_ENTER) {
            Factura.operacides();
            jtf_desc.setEnabled(false); 
           jTextField4.requestFocusInWindow();
       }
    }//GEN-LAST:event_jtf_descKeyPressed
