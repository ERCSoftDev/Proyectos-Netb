...
public class formaPagoAdmin extends javax.swing.JInternalFrame {
   ...
   String passWord;
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
     if(Factura.formaPago.getSelectedItem().equals("Contado")){
        try {    
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        try {
           ConsultaClientesrncAdmin bs = new ConsultaClientesrncAdmin();
...
if(Factura.formaPago.getSelectedItem().equals("Contado")){
       ...
       PagoAdmin.jTextField4.setEnabled(false);
       PagoAdmin.jTextField5.setEnabled(false);
}else if(Factura.formaPago.getSelectedItem().equals("Credito")){
    Factura.numfac();              
    Factura.numComprobF02();
    Factura.incrementarncf();
