...
public class BuscarClientevendedor extends javax.swing.JInternalFrame {
    ...
    private void SelecionaCLiente(){
       ...
       // DefaultTableModel modelo = (DefaultTableModel) Factura.jtableDetalle.getModel();
        ...
        String blue=jTable1.getValueAt(row, 7).toString();
         ...
         FacturaVendedor.jLabel16.setText(nom+" "+ape);
         FacturaVendedor.jLabel18.setText(ced);
         FacturaVendedor.telefo.setText(cel);
         FacturaVendedor.JLB_codCliente.setText(id);
         FacturaVendedor.jLabel20.setText(dir);
         FacturaVendedor.jTextField6.setText(blue);
