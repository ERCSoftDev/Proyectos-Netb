...
public class confNombreAdminComprobSusp extends javax.swing.JInternalFrame {
 ...
 ClassConection conectar=new ClassConection();
    ...
    public confNombreAdminComprobSusp() {
        initComponents();
    ...
    private void registarNombre(){
     ...
     String n_fact=   Factura.jTextField10.getText();
   ...
   // if(evt.getKeyCode() == KeyEvent.VK_ENTER) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(confNombreAdminComprobSusp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new confNombreAdminComprobSusp().setVisible(true);
            }
        });
    }
