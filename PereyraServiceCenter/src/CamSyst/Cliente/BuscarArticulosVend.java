...
public class BuscarArticulosVend extends javax.swing.JInternalFrame {
...
public BuscarArticulosVend() throws SQLException {
    initComponents();
 ...
 public void cargar(){
    ...
    private void initComponents() {
        ...
        jTextField1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 51, 51), 1, true));
        ...
        jTable1.setSelectionBackground(new java.awt.Color(255, 66, 66));
        ...
        String Itbis=jTable1.getValueAt(row, 5).toString();
         ...
         Object[]  dato=new Object[6];
           ...
           // Factura.calcularpuntos();
            modelo.addRow(dato);
            FacturaVendedor.jtableDetalle.setModel(modelo);
            FacturaVendedor.ajustarcolumnas();
            dispose();
