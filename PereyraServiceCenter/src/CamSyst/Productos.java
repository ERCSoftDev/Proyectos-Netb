...
desabilitar();
 ...
 double val1 = Double.parseDouble(precioLista.getText()); 
       ...
       double valorTotal =(suma); 
       precioVenta.setText(""+redondearpv(valorTotal,2)); 
 ...
 double val1 = Double.parseDouble(precioCosto.getText()); 
       double val2 = Double.parseDouble(itbis.getText()); 
       double suma = (val1 * val2)/100;
       
       double valorTotal = (suma); 
       jTextField16.setText(""+redondearItbis(valorTotal,2)); 
 ...
 double val1 = Double.parseDouble(precioVenta.getText()); 
       ...
       double valorTotal = (suma);
       jTextField18.setText(""+redondearItbis(valorTotal,2)); 
    
 }
    public  void  calcular()                 {
        int x= Integer.parseInt(precioLista.getText());
        int U= Integer.parseInt(jTextField17.getText());
        double z= x*U/100+x;
        precioVenta.setText(""+redondearItbis(z,2));
    
}
    
    //redondeos
    private static double redondearpv   (double itb,int numDecimal) {
     long p=1;
    ...
    private void initComponents() {
        ...
        precioLista.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                precioListaActionPerformed(evt);
            }
        });
        ...
        jTextField18.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#,##0.00"))));
        ...
        NuevoCliente.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
...
int row=        jTable1.getSelectedRow();
       ...
       // String vencimiento=     Productos.jTable1.getValueAt(row, 11).toString();     
        String codFabrica=      jTable1.getValueAt(row, 11).toString();
        String itbi=            jTable1.getValueAt(row, 12).toString();
        String valorItbis=      jTable1.getValueAt(row, 13).toString();
        String precioVconItbis= jTable1.getValueAt(row, 14).toString();
        
        this.jTextField1     .setText(cod);
        this.jTextField2     .setText(pro);
        this.jTextField3     .setText(det);
        this.jTextField7     .setText(prov);
        this.precioCosto     .setText(precioc);
        this.precioLista     .setText(prec);
        this.jTextField17    .setText(utilidad);
        this.precioVenta     .setText(preciov);
        this.jTextField6     .setText(stc);
        this.jTextField4     .setText(stoc);
        this.jTextField5     .setText(ubicacion);
        //this.jTextField9     .setText(vencimiento);
        
        this.jTextField14     .setText(codFabrica);
        this.jTextField16     .setText(valorItbis);
        this.itbis            .setText(itbi);
        this.jTextField18     .setText(precioVconItbis);
 ...
 if(evt.getClickCount()==1){
    ...
    private void precioListaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_precioListaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_precioListaActionPerformed
