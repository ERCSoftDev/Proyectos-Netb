...
import CamSyst.Cliente.PagoCajerosComprobante;
import CamSyst.Cliente.cliente;
import CamSyst.Cliente.confNombreAdminComprob;
import CamSyst.Cliente.confNombreCajaComprob;
import CamSyst.Cliente.confNombreCajaComprobSusp;
import java.sql.*;
...
public class ConsultaClientesrncCajeroSusp extends javax.swing.JInternalFrame {
   ...
   String userName;
   String passWord;
    public ConsultaClientesrncCajeroSusp() {
        initComponents();
...
public void Selecionacliente(){
      ...
      //  String STATUS=jTable1      .getValueAt(row, 8).toString();
        ...
        FacturaCajeros.JLB_codCliente.setText("C0000");
        FacturaCajeros.jLabel16.setText(NOM);
        FacturaCajeros.jLabel18.setText(RNC);
        FacturaCajeros.jLabel20.setText(DIR);
        FacturaCajeros.telefo.setText(TELE);
...
public void goToURL(String URL) throws IOException{
    ...
    private void initComponents() {
        ...
        jButton3.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(51, 204, 0), 1, true));
    ...
    private void jTable1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyPressed
     Selecionacliente(); 
         try {       
          FacturaCajeros.enviarFacturaComprobSusp();
         FacturaCajeros.operaci();
         String nombre=FacturaCajeros.jLabel16.getText();
        confNombreCajaComprobSusp.jTextField1.setText(nombre);
         this.dispose();
       } catch (Exception e){}
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            Logger.getLogger(ConsultaClientesrncCajeroSusp.class.getName()).log(Level.SEVERE, null, ex);
        }
