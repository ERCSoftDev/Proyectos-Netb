...
public class ConsultaClientesrncVend extends javax.swing.JInternalFrame {
   ...
   String userName;
   String passWord;
    public ConsultaClientesrncVend() {
        initComponents();
        //userName=user;
        //passWord=password;
...
public void Selecionacliente(){
        ...
        FacturaVendedor.JLB_codCliente.setText(codigo);
        FacturaVendedor.jLabel16.setText(nom+" "+apellido);
        FacturaVendedor.jLabel18.setText(rnc);
        FacturaVendedor.jLabel20.setText(dir);
        FacturaVendedor.telefo.setText(tel);
...
public void goToURL(String URL) throws IOException{
    ...
    private void jTable1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyPressed
     Selecionacliente(); 
        try {
        FacturaVendedor.enviarFacturaComprob();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            Logger.getLogger(ConsultaClientesrncVend.class.getName()).log(Level.SEVERE, null, ex);
        }
