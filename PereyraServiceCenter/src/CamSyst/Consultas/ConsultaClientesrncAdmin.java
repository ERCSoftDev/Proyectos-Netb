...
public class ConsultaClientesrncAdmin extends javax.swing.JInternalFrame {
   ...
   String userName;
   String passWord;
    public ConsultaClientesrncAdmin() {
        initComponents();
...
public void goToURL(String URL) throws IOException{
    ...
    private void jTable1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyPressed
     Selecionacliente(); 
        try {
         Factura.enviarFacturaComprob();
         Factura.operaci();
         String nombre=Factura.jLabel16.getText();
        confNombreAdminComprob.jTextField1.setText(nombre);
         this.dispose();
       } catch (Exception e){}
        this.dispose();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            Logger.getLogger(ConsultaClientesrncAdmin.class.getName()).log(Level.SEVERE, null, ex);
        }
