...
public class ConsultaClientesrncCajero extends javax.swing.JInternalFrame {
   ...
   String userName;
   String passWord;
    public ConsultaClientesrncCajero() {
        initComponents();
...
public void goToURL(String URL) throws IOException{
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            Logger.getLogger(ConsultaClientesrncCajero.class.getName()).log(Level.SEVERE, null, ex);
        }
