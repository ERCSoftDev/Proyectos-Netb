...
public class ConsultaClientesrncAdminSusp extends javax.swing.JInternalFrame {
   ...
   String userName;
   String passWord;
    public ConsultaClientesrncAdminSusp() {
        initComponents();
...
public void Selecionacliente(){
      ...
      //  String STATUS=jTable1      .getValueAt(row, 8).toString();
        ...
        Factura.JLB_codCliente.setText("C0000");
        Factura.jLabel16.setText(NOM);
        Factura.jLabel18.setText(RNC);
        Factura.jLabel20.setText(DIR);
        Factura.telefo.setText(TELE);
...
public void goToURL(String URL) throws IOException{
    ...
    private void jTable1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyPressed
     Selecionacliente(); 
        try {
         Factura.enviarFacturaComprobSusp();
         Factura.operaci();
         String nombre=Factura.jLabel16.getText();
        confNombreAdminComprobSusp.jTextField1.setText(nombre);
         this.dispose();
       } catch (Exception e){}
        this.dispose();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            Logger.getLogger(ConsultaClientesrncAdminSusp.class.getName()).log(Level.SEVERE, null, ex);
        }
